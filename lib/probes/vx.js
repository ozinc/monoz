...
function queueMetric(props, step, delta) {
...
//      console.log(' Fetching master Playlist using '+ masterPlaylist);
    ...
    .spread(function (res, body) {
      ...
      queueMetric(props, 'master playlist', diff);
    ...
    .spread(function (res, body) {
      ...
      queueMetric(props, 'media playlist', diff);
      var lines = body.split('\n');
    ...
    .spread(function (res, body) {
      ...
      queueMetric(props, 'video segment', diff);
    })
    .finally(function () {
      return callback();
    })
